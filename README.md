...
After installing all the dependencies, run demo code ``demo_synthetic_data_white_noise.py`` and ``demo_synthetic_data_colored_noise.py`` for synthetic simulations with white and colored noise respectively.
